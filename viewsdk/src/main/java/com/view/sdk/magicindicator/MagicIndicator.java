package com.view.sdk.magicindicator;
...
import com.view.sdk.magicindicator.abs.IPagerNavigator;
...
public class MagicIndicator extends FrameLayout {
    ...
    public void setNavigator(IPagerNavigator navigator) {
        ...
        if (mNavigator instanceof View) {
            ...
            ((View)mNavigator).setClickable(true);
            ((ViewGroup)mNavigator).setClipChildren(true);
