...
/**
 * A delegate for Fragments to attach them to mosby mvp. <p> The following methods must be invoked from the
 * corresponding Fragments lifecycle methods:
 * <p>
 * <ul> <li>{@link #onCreate(Bundle)}</li> <li>{@link #onDestroy()}</li> <li>{@link #onPause()} </li> <li>{@link
 * #onResume()} </li> <li>{@link #onStart()} </li> <li>{@link #onStop()} </li> <li>{@link #onViewCreated(View, Bundle)}
 * </li> <li>{@link #onActivityCreated(Bundle)} </li> <li>{@link #onSaveInstanceState(Bundle)} </li> <li>{@link
 * #onAttach(Activity)} </li> <li>{@link #onDetach()}</li> <li></li> </ul> </p>
 *
