...
public class FragmentMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
    ...
    public void onViewCreated(View view, @Nullable Bundle bundle) {
        ...
        if (bundle != null && keepPresenterInstanceDuringScreenOrientationChanges) {
            ...
            if (mosbyViewId != null &&
                ...
                if (DEBUG) {
                    Log.d(DEBUG_TAG, "No presenter found although view Id was here: " + mosbyViewId +
                            ". Most likely this was caused by a process death. New Presenter created" +
                            presenter + " for view " + getMvpView());
                }
            }
        } else {
            //
    ...
    public void onDestroyView() {
        ...
        if (!retainPresenterInstance && mosbyViewId !=
        ...
        if (DEBUG) {
            Log.d(DEBUG_TAG,
                    "detached MvpView from Presenter. MvpView " + delegateCallback.getMvpView() + "   Presenter: " +
                            presenter);
            Log.d(DEBUG_TAG,
                    "Retaining presenter instance: " + Boolean.toString(retainPresenterInstance) + " " + presenter);
        }
    }
    ...
    public void onStart() {
        ...
        if (!onViewCreatedCalled) {
            throw new IllegalStateException(
                    "It seems that you are using " + delegateCallback.getClass().getCanonicalName() +
