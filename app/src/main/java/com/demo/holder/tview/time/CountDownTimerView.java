package com.demo.holder.tview.time;
...
public class CountDownTimerView extends AppCompatTextView {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, cn.tegele.com.tview.R.styleable.CountDownTimerView, defStyleAttr, 0);

        if (a != null) {
            mPrefixText = a.getString(cn.tegele.com.tview.R.styleable.CountDownTimerView_prefixText);
            mSuffixText = a.getString(cn.tegele.com.tview.R.styleable.CountDownTimerView_suffixText);

            String milliStr = a.getString(cn.tegele.com.tview.R.styleable.CountDownTimerView_timeMilliSeconds);
            if (!TextUtils.isEmpty(milliStr) && TextUtils.isDigitsOnly(milliStr)) {
                mMilliSeconds = Long.parseLong(a.getString(cn.tegele.com.tview.R.styleable.CountDownTimerView_timeMilliSeconds));
